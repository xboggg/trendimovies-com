import { w as NOOP_MIDDLEWARE_HEADER, R as REDIRECT_STATUS_CODES, A as AstroError, x as ActionsReturnedInvalidDataError, D as DEFAULT_404_COMPONENT } from './astro/server_Di6iaaQd.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { PORT: "3000", _: process.env._ })?.DEV) {
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { PORT: "3000", _: process.env._ })?.PROD) {
