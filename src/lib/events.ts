...
export const filmEvents: FilmEvent[] = [
  ...
  },
  {
    ...
    name: 'Golden Globe Awards 2026',
    shortName: 'Golden Globes 2026',
    year: 2026,
    status: 'past',
    ...
    description: "The 83rd Golden Globe Awards. 'Hamnet' won Best Motion Picture — Drama and 'One Battle After Another' took Best Picture — Musical or Comedy plus three more.",
    color: '#B8860B',
    accentColor: '#FFD700',
    emoji: '🏅',
    slug: 'golden-globes-2026',
    pageUrl: '/event/golden-globes-2026',
    categories: ['Best Motion Picture Drama', 'Best Motion Picture Musical or Comedy', 'Best Director', 'Best Actress', 'Best Actor'],
    highlights: ['83rd Edition', 'January 11, 2026', 'Beverly Hills, CA'],
    topAward: 'Best Motion Picture — Drama',
    winner: 'Hamnet',
    edition: '83rd',
    results: [
      { category: 'Best Motion Picture — Drama', winner: 'Hamnet' },
      { category: 'Best Motion Picture — Musical or Comedy', winner: 'One Battle After Another' },
      { category: 'Best Director', winner: 'Paul Thomas Anderson — One Battle After Another' },
      { category: 'Best Screenplay', winner: 'Paul Thomas Anderson — One Battle After Another' },
      { category: 'Best Actress — Drama', winner: 'Jessie Buckley — Hamnet' },
      { category: 'Best Actor — Drama', winner: 'Wagner Moura — The Secret Agent' },
      { category: 'Best Actress — Musical or Comedy', winner: 'Rose Byrne — If I Had Legs I’d Kick You' },
      { category: 'Best Actor — Musical or Comedy', winner: 'Timothée Chalamet — Marty Supreme' },
      { category: 'Best Supporting Actress', winner: 'Teyana Taylor — One Battle After Another' },
      { category: 'Best Supporting Actor', winner: 'Stellan Skarsgård — Sentimental Value' },
    ],
  },
  {
  ...
  },
  {
    ...
    edition: '78th',
    results: [
      { category: "Palme d'Or", winner: 'It Was Just an Accident — Jafar Panahi' },
      { category: 'Grand Prix', winner: 'Sentimental Value — Joachim Trier' },
      { category: 'Jury Prize', winner: 'Sirât — Oliver Laxe & Sound of Falling — Mascha Schilinski (tie)' },
      { category: 'Best Director', winner: 'Kleber Mendonça Filho — The Secret Agent' },
      { category: 'Best Actor', winner: 'Wagner Moura — The Secret Agent' },
      { category: 'Best Actress', winner: 'Nadia Melliti — Little Sister' },
      { category: 'Best Screenplay', winner: 'Jean-Pierre & Luc Dardenne — Young Mothers' },
      { category: "Caméra d'Or", winner: "The President's Cake — Hasan Hadi" },
      { category: 'Un Certain Regard Prize', winner: 'The Mysterious Gaze of the Flamingo — Diego Céspedes' },
    ],
  },
  {
    id: 'oscars-2025',
    ...
    location: 'Hollywood, CA',
    venue: 'Dolby Theatre',
    description: "The 97th Academy Awards ceremony. 'Anora' was the night's biggest winner, taking Best Picture, Director, Actress, Editing and Original Screenplay.",
    color: '#D4AF37',
    accentColor: '#FFD700',
    emoji: '🏆',
    slug: 'oscars-2025',
    pageUrl: '/event/oscars-2025',
    categories: ['Best Picture', 'Best Director', 'Best Actor', 'Best Actress', 'Supporting Actor', 'Supporting Actress'],
    highlights: ['97th Edition', 'March 2, 2025', 'Dolby Theatre'],
    topAward: 'Best Picture',
    winner: 'Anora',
    edition: '97th',
    results: [
      { category: 'Best Picture', winner: 'Anora' },
      { category: 'Best Director', winner: 'Sean Baker — Anora' },
      { category: 'Best Actor', winner: 'Adrien Brody — The Brutalist' },
      { category: 'Best Actress', winner: 'Mikey Madison — Anora' },
      ...
      { category: 'Best Original Screenplay', winner: 'Anora — Sean Baker' },
      { category: 'Best Film Editing', winner: 'Anora' },
    ],
  },
  {
    id: 'berlinale-2026',
