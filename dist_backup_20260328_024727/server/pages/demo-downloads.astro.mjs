...
</p> </div> <!-- Full Example (DDL + Torrent) --> <div> <h2 class="text-2xl font-semibold mb-4" style="color: var(--text-primary);">Full Download Options</h2> ${renderComponent($$result2, "DownloadSection", DownloadSection, { "client:load": true, "title": "Moana 2", "links": demoLinks, "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/DownloadSection.svelte", "client:component-export": "default" })} </div> <!-- DDL Only --> <div> <h2 class="text-2xl font-semibold mb-4" style="color: var(--text-primary);">DDL Only</h2> ${renderComponent($$result2, "DownloadSection", DownloadSection, { "client:load": true, "title": "Movie Name", "links": ddlOnlyLinks, "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/DownloadSection.svelte", "client:component-export": "default" })} </div> <!-- Torrent Only --> <div> <h2 class="text-2xl font-semibold mb-4" style="color: var(--text-primary);">Torrent Only</h2> ${renderComponent($$result2, "DownloadSection", DownloadSection, { "client:load": true, "title": "", "links": torrentOnlyLinks, "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/DownloadSection.svelte", "client:component-export": "default" })} </div> <!-- Empty State --> <div> <h2 class="text-2xl font-semibold mb-4" style="color: var(--text-primary);">No Downloads Yet</h2> ${renderComponent($$result2, "DownloadSection", DownloadSection, { "client:load": true, "title": "", "links": emptyLinks, "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/DownloadSection.svelte", "client:component-export": "default" })} </div> </div> ` })}`;
}, "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/pages/demo-downloads.astro", void 0);

const $$file = "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/pages/demo-downloads.astro";
