...
import 'piccolore';
import { L as Link_2, $ as $$AdminLayout } from '../chunks/AdminLayout_BfxhxgmD.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ]), "emptyMessage": "No view data yet", "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/admin/DataTable.svelte", "client:component-export": "default" })} </div> <div class="bg-[#141414] rounded-xl border border-[#2a2a2a] p-6"> <h3 class="text-lg font-semibold mb-4">Top 10 Most Viewed Series</h3> ${renderComponent($$result2, "DataTable", DataTable, { "client:load": true, "columns": ["#", "Title", "Year", "Views"], "rows": stats.topViewed.series.map((s, i) => [
    i + 1,
    s.title,
    s.year || "-",
    (s.view_count || 0).toLocaleString()
  ]), "emptyMessage": "No view data yet", "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/admin/DataTable.svelte", "client:component-export": "default" })} </div> </div> ` })}`;
}, "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/pages/admin/index.astro", void 0);

const $$file = "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/pages/admin/index.astro";
const $$url = "/admin";
