...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const ogRating = movie.vote_average ? `\u2B50 ${movie.vote_average.toFixed(1)}` : "";
  const ogGenres = movie.genres?.length > 0 ? movie.genres.map((g) => g.name).join(", ") : "";
