...
import { C as ContentRow } from '../chunks/ContentRow_wPOylydR.mjs';
import { a as ContinueWatching, C as Collections, P as PickYourMood } from '../chunks/ContinueWatching_C_SIXuTe.mjs';
import { m as getTrendingMovies, q as getNowPlayingMovies, r as getPopularMovies, k as getTopRatedMovies, d as discoverMovies, n as getTrendingTV, u as getPopularTV, v as getOnTheAirTV, c as discoverTV, e as getMovieGenres, g as getMovieDetails, i as getTVDetails, a as searchMovies } from '../chunks/tmdb_DKnoDzGN.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const [trending, nowPlaying, popular, topRated, upcomingData, trendingTV, popularTV, onTheAirTV, actionMovies, comedyMovies, romanceMovies, thrillerMovies, animeMovies, kDramaTV, movieGenres, latestAdditions] = await Promise.all([
    ...
    discoverMovies({ with_genres: "53", sort_by: "popularity.desc" }),
    discoverMovies({ with_genres: "16", with_original_language: "ja", sort_by: "popularity.desc" }),
    discoverTV({ with_original_language: "ko", sort_by: "popularity.desc" }),
    getMovieGenres(),
    getLatestAdditions()
  ]);
  const upcoming = (upcomingData?.results || []).filter((m) => m.poster_path && m.release_date && new Date(m.release_date) > /* @__PURE__ */ new Date());
  ...
  const trendingItems = (trending || []).slice(0, 20).map(transformMovie);
  ...
  const romanceItems = (romanceMovies?.results || []).slice(0, 15).map(transformMovie);
  const thrillerItems = (thrillerMovies?.results || []).slice(0, 15).map(transformMovie);
  const animeItems = (animeMovies?.results || []).slice(0, 15).map(transformMovie);
  const kDramaItems = (kDramaTV?.results || []).slice(0, 15).map(transformTV);
  const oscarTitles = [
    "Sinners",
  ...
  const top2026 = (top2026Data?.results || []).slice(0, 20).map(transformMovie);
  const top2024_25 = (top2024_25Data?.results || []).slice(0, 20).map(transformMovie);
  const top2020_23 = (top2020_23Data?.results || []).slice(0, 20).map(transformMovie);
  async function getBoxOfficeData() {
    try {
      const res = await fetch(
        `${POSTGREST_URL}/box_office_weekly?order=week_start.desc,rank.asc&limit=15`
      );
      if (!res.ok) return [];
      const data = await res.json();
      if (data.length === 0) return [];
      const latestWeek = data[0].week_start;
      return data.filter((d) => d.week_start === latestWeek).slice(0, 7).map((d) => ({
        rank: d.rank,
        title: d.movie_title,
        weekend_gross: d.three_day_gross ? `$${(d.three_day_gross / 1e6).toFixed(1)}M` : "-",
        total_gross: d.total_gross > 1e5 ? `$${(d.total_gross / 1e6).toFixed(1)}M` : d.three_day_gross ? `$${(d.three_day_gross / 1e6).toFixed(1)}M` : "-",
        tmdb_id: d.tmdb_id || 0,
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Watch Movies & TV Series Online Free" }, { "default": async ($$result2) => renderTemplate`  ${renderComponent($$result2, "HeroCarousel", HeroCarousel, { "client:load": true, "featured": featured, "trending": heroItems, "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/HeroCarousel.svelte", "client:component-export": "default" })}  ${trendingItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:load": true, "title": "Trending This Week", "items": trendingItems, "seeAllLink": "/trending", "autoScroll": true, "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${renderComponent($$result2, "FeaturedSection", FeaturedSection, { "client:load": true, "oscarMovies": oscarMovies, "top2026": top2026, "top2024_25": top2024_25, "top2020_23": top2020_23, "boxOffice": boxOfficeWithPosters, "comingSoon": upcoming.slice(0, 10).map(transformMovie), "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/FeaturedSection.svelte", "client:component-export": "default" })}  ${latestAdditionItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:load": true, "title": "Latest Additions", "items": latestAdditionItems, "seeAllLink": "/movies/latest", "autoScroll": false, "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${nowPlayingItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:load": true, "title": "Now Playing in Theaters", "items": nowPlayingItems, "seeAllLink": "/movies?filter=now_playing", "autoScroll": true, "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${upcomingItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "Coming Soon", "items": upcomingItems, "seeAllLink": "/movies/upcoming", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${popularItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "Popular Movies", "items": popularItems, "seeAllLink": "/movies", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${tvItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "Trending TV Series", "items": tvItems, "seeAllLink": "/series", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${renderComponent($$result2, "ContinueWatching", ContinueWatching, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContinueWatching.svelte", "client:component-export": "default" })}  ${renderComponent($$result2, "Collections", Collections, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/Collections.svelte", "client:component-export": "default" })}  ${renderComponent($$result2, "PickYourMood", PickYourMood, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/PickYourMood.svelte", "client:component-export": "default" })}  ${onTheAirItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "New Episodes This Week", "items": onTheAirItems, "seeAllLink": "/series/new-episodes", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${actionItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "Action Movies", "items": actionItems, "seeAllLink": "/genre/action", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${comedyItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "Comedy Movies", "items": comedyItems, "seeAllLink": "/genre/comedy", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${romanceItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "Romance Movies", "items": romanceItems, "seeAllLink": "/genre/romance", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${thrillerItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "Thriller Movies", "items": thrillerItems, "seeAllLink": "/genre/thriller", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${animeItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "Anime Movies", "items": animeItems, "seeAllLink": "/genre/anime", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${kDramaItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "K-Drama Series", "items": kDramaItems, "seeAllLink": "/genre/k-drama", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`} ${topRatedItems.length > 0 && renderTemplate`${renderComponent($$result2, "ContentRow", ContentRow, { "client:visible": true, "title": "Top Rated", "items": topRatedItems, "seeAllLink": "/top-rated", "client:component-hydration": "visible", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/ContentRow.svelte", "client:component-export": "default" })}`}` })}`;
}, "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/pages/index.astro", void 0);
const $$file = "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/pages/index.astro";
const $$url = "";
