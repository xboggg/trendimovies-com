...
import 'piccolore';
import { A as Activity, $ as $$AdminLayout } from '../../chunks/AdminLayout_BfxhxgmD.mjs';
...
const $$Crons = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "AdminLayout", $$AdminLayout, { "title": "Cron Jobs", "activeTab": "crons" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "CronMonitor", CronMonitor, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/admin/CronMonitor.svelte", "client:component-export": "default" })} ` })}`;
}, "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/pages/admin/crons.astro", void 0);

const $$file = "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/pages/admin/crons.astro";
