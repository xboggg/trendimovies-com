...
const $$Requests = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "AdminLayout", $$AdminLayout, { "title": "Content Requests", "activeTab": "requests" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<p class="text-[#888] mb-6">User-submitted movie and series requests</p> ${renderComponent($$result2, "RequestsManager", RequestsManager, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/components/admin/RequestsManager.svelte", "client:component-export": "default" })} ` })}`;
}, "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/pages/admin/requests.astro", void 0);

const $$file = "C:/Users/CyberAware/OneDrive - Government of Ghana - CAGD/ZeroTrust/Visual Studio Code Workspace/trendimovies-com/src/pages/admin/requests.astro";
